  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color(0xFFA40606),
        elevation: 20,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: Color(0xFFEAEAEA), // Set background color
            ...
            Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: Color(0xFFEAEAEA), // Light gray background
                    borderRadius: BorderRadius.circular(17.0),
                    border: Border.all(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ButtonStyle(
                        backgroundColor:
                            MaterialStateProperty.all<Color>(Color(0xFFA40606)),
                        foregroundColor:
